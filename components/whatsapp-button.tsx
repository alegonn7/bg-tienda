...
export function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center justify-center shadow-lg transition-transform hover:scale-110"
      style={{ backgroundColor: '#25d366', borderRadius: '50%', width: '68px', height: '68px' }}
    >
      <svg width="42" height="42" viewBox="0 0 24 24" fill="#ffffff" aria-hidden="true">
