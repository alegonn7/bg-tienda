...
// Los Server Actions de envío llaman a las Edge Functions de bg-gestion con esto en vez de
// usar supabase.functions.invoke crudo — mismo motivo que lib/mercadopago.ts:
